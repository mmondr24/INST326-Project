...
Class TurboTrainer:
‘ ‘ ‘ This class will hold the data with the actual definition and terms. After completing the terms, it holds the quiz function for the user to play the game and the points function to track your points. 
   ...
   Attributes:
	...
	‘ ‘ ‘ This function tracks the points of the users depending on if they get the answers correct or not. ’ ’ ’
		correct = 0
		incorrect = 0
